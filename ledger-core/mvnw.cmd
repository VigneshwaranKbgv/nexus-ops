...
@REM set %~dp0 is the directory of this file
set DIRNAME=%~dp0
if "%DIRNAME%" == "" set DIRNAME=.\

@REM Enable configure-on-demand for high performance
...
@REM Find the project base dir, i.e. the directory containing the .mvn directory
:findBaseDir
...
:error
echo Error: Could not find project base directory containing .mvn
...
:run
@REM Downloader using PowerShell
if exist "%WRAPPER_JAR%" goto runWrapper

echo Downloading Maven build wrapper...
